...
import 'package:smart_notes/services/dialog/dialog_service.dart';
...
class _DialogManagerWidgetState extends State<DialogManagerWidget> {
  ...
  void initState() {
    ...
    _dialogService.registerCallbacks(
      ...
      onConfirm: (message, title, ok, cancel) =>
          _showConfirmationDialog(message, title, ok, cancel),
  ...
  Future<bool> _showConfirmationDialog(
      String message, String title, String ok, String cancel) async {
    assert(message != null);
    assert(ok != null);
    assert(cancel != null);
