...
import 'package:smart_notes_business/src/mappers/account/google_account_mapper.dart';
...
abstract class AccountMapper
    extends EntityDataObjectMapper<AccountEntity, AccountDataObject> {
...
class AccountMapperImpl implements AccountMapper {
  ...
  @override
  AccountEntity toEntityFromGoogleAccount(GoogleSignInAccount source) =>
      _googleAccountMapper.toEntity(source);
}
