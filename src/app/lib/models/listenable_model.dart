...
abstract class ListenableModel extends Model {
  ...
  void addOnModelChanged(ModelChangeCallback callback) => _callbacks.add(callback);

  void removeOnModelChanged(ModelChangeCallback callback) => _callbacks.remove(callback);
